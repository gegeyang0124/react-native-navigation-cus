...
class Header extends React.PureComponent {
    ...
    _renderLeftComponent = props => {
        // console.info("_renderLeftComponent props:",props);
        ...
        // console.info("getScreenDetails:",this.props.getScreenDetails(props.scene));
        ...
        // console.info("HeaderBackButton:",RenderedLeftComponent);
        // console.info("options:",options);
        return (
            <RenderedLeftComponent
                onPress={()=>this._navigateBack(options)}
